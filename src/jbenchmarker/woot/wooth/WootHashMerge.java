...
public class WootHashMerge extends MergeAlgorithm {
    ...
    public WootHashMerge() {
        super();
        pending = new java.util.HashMap<WootIdentifier, WootOperation>();
        clock = 0;
    }
...
//        WootHashDocument<? extends WootNode> wdoc = (WootHashDocument<? extends WootNode>) (this.getDoc());
