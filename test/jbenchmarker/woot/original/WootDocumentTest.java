...
import jbenchmarker.woot.original.WootOriginalNode;
...
public class WootDocumentTest {
    ...
    public void testApply() {
        ...
        instance.applyLocal(ins(instance,a));
        assertEquals("a", instance.view());
        
        instance.applyLocal(ins(instance,b));
        assertEquals("ab", instance.view());

        instance.applyLocal(ins(instance,d));
        assertEquals("dab", instance.view());

        instance.applyLocal(del(instance,d));
        assertEquals("ab", instance.view());
        
        instance.applyLocal(ins(instance,e));
        assertEquals("aeb", instance.view());

        instance.applyLocal(del(instance,e));
        assertEquals("ab", instance.view());
    
        instance.applyLocal(ins(instance,g));
        assertEquals("agb", instance.view());

        instance.applyLocal(ins(instance,h));
    ...
    public void wootPuzzle() {
        ...
        instance.applyLocal(ins(instance,a));
        instance.applyLocal(ins(instance,d));
        instance.applyLocal(ins(instance,x));
